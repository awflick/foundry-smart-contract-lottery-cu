...
contract RaffleTest is CodeConstants, Test {
    ...
    function testPerformUpKeepRevertsIfCkeckUpKeepIsFalse() public {
        // Arrange
        uint256 currentBalance = 0;
        uint256 numPlayers = 0;
        Raffle.RaffleState rStae = raffle.getRaffleState();
        ...
        // Act / Assert
        vm.expectRevert(
            abi.encodeWithSelector(Raffle.Raffle__UpkeepNotNeeded.selector, currentBalance, numPlayers, rStae));
        raffle.performUpkeep("");
    }
    ...
    // What if we need to get data fromour emitted events in our tests?
